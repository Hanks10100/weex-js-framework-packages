(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK: 0.14.1 Build 20160701');
	  ...
	  if (children && children.length) {
	    var _ret = function () {
	      ...
	      children.every(function (child) {
	        lastSignal = _this3._compile(child, dest) !== -1;
	        return lastSignal;
	      });
	      return {
	        v: lastSignal
